...
FLAGS['modelDir'] = FLAGS['rootPath'] + 'models/IJEPA_convnext_tiny/'
...
def modelSetup(classes):
    ...
    model = timm.create_model('convnext_tiny', pretrained=False, num_classes=0, global_pool='', drop_path_rate=0.2)
